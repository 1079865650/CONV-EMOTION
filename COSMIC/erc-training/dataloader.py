...
class IEMOCAPRobertaCometDataset(Dataset):
    ...
    def __init__(self, split):
        ...
        = pickle.load(open('data/erc-training/iemocap/iemocap_features_roberta.pkl', 'rb'), encoding='latin1')
        ...
        = pickle.load(open('data/erc-training/iemocap/iemocap_features_comet.pkl', 'rb'), encoding='latin1')
